 ...
 * @Description 视频列表 adapter pad
 */
public class PadVideoListAdapter extends BaseAdapter {

	private List<InternalVideoModel> list = new ArrayList<InternalVideoModel>();
	private Context context;

	public PadVideoListAdapter(Context context, String TAG, List<InternalVideoModel> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(R.layout.pad_video_list_item, null);
