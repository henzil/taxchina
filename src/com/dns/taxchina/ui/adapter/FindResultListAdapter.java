...
public class FindResultListAdapter extends BaseAdapter {
	...
	public FindResultListAdapter(Context context, String TAG) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(R.layout.find_result_list_item, null);
	...
	public class ViewHolder {
		...
		public ViewHolder(View view) {
			icon = (ImageView) view.findViewById(R.id.find_result_item_img);
			title = (TextView) view.findViewById(R.id.find_result_item_title_text);
			text = (TextView) view.findViewById(R.id.find_result_item_info_text);
			line = view.findViewById(R.id.find_result_item_line);
		}
