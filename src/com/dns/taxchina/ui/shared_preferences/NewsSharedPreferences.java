 ...
 * @Description 记录上次咨询请求时间
 */
public class NewsSharedPreferences {

	private static final String NEWS_REQUEST_DATE = "news_request_date";
	...
	public static void saveLastRequestDate(Context context){
		SharedPreferences sp = context.getSharedPreferences(AppUtil.getPackageName(context) + NEWS_REQUEST_DATE, Context.MODE_WORLD_WRITEABLE);
